...
export const buttonVariantsOptions = {
  base: 'inline-flex items-center justify-center whitespace-nowrap border border-gray-200 rounded-md active:scale-97 transition-all cursor-pointer disabled:pointer-events-none disabled:cursor-not-allowed shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]',
